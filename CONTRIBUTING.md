...
- Make sure to check if an [issue exists](https://github.com/M0nster0p/Musific) already & see if the issue is assigned to anyone or not.
...
If you spot something new, open an issue using a [template](https://github.com/M0nster0p/Musific). We'll use the issue to have a conversation about the problem you want to fix.
...
Once your PR is merged, you will be proudly listed as a contributor in the [contributor chart](https://github.com/M0nster0p/Musific).
